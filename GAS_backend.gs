...
var FORM_SHEETS_CONFIG = [
  { sheetName: '【西船橋店】オンダリフト', shopCode: 'ONDARI_NISHIFUNA', shopLabel: '西船橋店 オンダリフト', lineChannel: 'LINE_NISHIFUNA' },
  { sheetName: '【西船橋店】ピーリング', shopCode: 'PEELING_NISHIFUNA', shopLabel: '西船橋店 ピーリング', lineChannel: 'LINE_NISHIFUNA' }
];
